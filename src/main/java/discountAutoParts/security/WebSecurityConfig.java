package  discountAutoParts.security;
...
import discountAutoParts.services.LoginCredentialsService;
   ...
   AuthenticationManager authenticationManager(AuthenticationConfiguration authenticationConfiguration) throws Exception {
	...
	protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf()
					.disable()
					.authorizeRequests()
					.requestMatchers("/CustomerRegistration", "/AdminLogin","/VendorLogin","/CustomerLogin")
